...
class TestVictoriaLogsToolAvailability:
    ...
    def test_tool_importable(self) -> None:
        from integrations.victoria_logs.tools import VictoriaLogsTool, victoria_logs_query
    ...
    def test_tool_unavailable_without_source(self) -> None:
        from integrations.victoria_logs.tools import victoria_logs_query
    ...
    @patch("integrations.victoria_logs.tools.make_victoria_logs_client")
