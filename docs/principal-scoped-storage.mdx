...
| --- | --- | --- |
| Slack | Organization from `OPENSRE_ORGANIZATION_ID` | Slack user id |
...
| Env | Purpose |
| --- | --- |
| `OPENSRE_ORGANIZATION_ID` | The organization this deployment serves. Required for Slack turns, and required to use `OPENSRE_CONTEXT_ROOT` |
