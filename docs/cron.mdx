...
description: "Cron-driven recurring reports to Telegram, Slack, Discord, and Rocket.Chat"
---
...
# Same kind to Slack (channel id C…)
opensre cron add --kind daily_summary --cron "0 9 * * 1-5" \
...
| `--provider` | Yes | Messaging provider: `telegram`, `slack`, `discord`, `rocketchat` |
